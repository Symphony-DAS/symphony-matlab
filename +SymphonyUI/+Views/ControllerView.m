classdef ControllerView < SymphonyUI.View
    ...
    methods
        ...
        function createInterface(obj)
            ...
            set(obj.figureHandle, 'Position', [759 543 294 122]);
            ...
            obj.controls.runButton = uicontrol( ...
                ...
                'Style', 'pushbutton', ...
                'CData', imread('play.png', 'BackgroundColor', [1 1 1]), ...
                'BackgroundColor', 'w', ...
                'TooltipString', 'Run', ...
                'Callback', @p.onSelectedRunProtocol);
            obj.controls.pauseButton = uicontrol( ...
                'Parent', controlLayout, ...
                'Style', 'pushbutton', ...
                'CData', imread('pause.png', 'BackgroundColor', [1 1 1]), ...
                'BackgroundColor', 'w', ...
                'TooltipString', 'Pause', ...
                'Callback', @p.onSelectedPauseProtocol);
            obj.controls.stopButton = uicontrol( ...
                'Parent', controlLayout, ...
                'Style', 'pushbutton', ...
                'CData', imread('stop.png', 'BackgroundColor', [1 1 1]), ...
                'BackgroundColor', 'w', ...
                'TooltipString', 'Stop', ...
                'Callback', @p.onSelectedStopProtocol);
            obj.controls.editParametersButton = uicontrol( ...
                'Parent', controlLayout, ...
                'Style', 'pushbutton', ...
                'CData', imread('menu.png', 'BackgroundColor', [1 1 1]), ...
                'BackgroundColor', 'w', ...
