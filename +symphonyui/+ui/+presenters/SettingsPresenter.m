classdef SettingsPresenter < symphonyui.ui.Presenter
    ...
    methods
        ...
        function obj = SettingsPresenter(app, view)            
            ...
            obj.addListener(view, 'SelectedCard', @obj.onViewSelectedCard);
            obj.addListener(view, 'ShowedCard', @obj.onViewShowedCard);
    ...
    methods (Access = private)
        ...
        function onViewSelectedCard(obj, ~, ~)
            c = obj.view.getCard();
            obj.view.setCard(c);
        end
        
        function onViewShowedCard(obj, ~, ~)
            c = obj.view.getCard();
            disp(['View Showed Card ' c]);
        end
