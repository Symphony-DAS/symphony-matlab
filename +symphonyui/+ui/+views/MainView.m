    ...
    methods
        ...
        function createUi(obj)
            ...
            obj.viewMenu.root = uimenu(obj.figureHandle, ...
                'Label', 'View');
            obj.viewMenu.showRig = uimenu(obj.viewMenu.root, ...
                'Label', 'Rig', ...
                'Accelerator', '1', ...
                'Callback', @(h,d)notify(obj, 'ShowRig'));
            obj.viewMenu.showExperiment = uimenu(obj.viewMenu.root, ...
                'Label', 'Experiment', ...
                'Accelerator', '2', ...
            ...
            obj.configureMenu.showDeviceBackgrounds = uimenu(obj.configureMenu.root, ...
                'Label', 'Device Backgrounds...', ...
                'Accelerator', 'B', ...
                'Callback', @(h,d)notify(obj, 'ShowDeviceBackgrounds'));
            obj.configureMenu.showSettings = uimenu(obj.configureMenu.root, ...
                'Label', 'Settings...', ...
                'Separator', 'on', ...
                'Callback', @(h,d)notify(obj, 'ShowSettings'));
        ...
        function enableShowExperiment(obj, tf)
            set(obj.viewMenu.showExperiment, 'Enable', symphonyui.ui.util.onOff(tf));
        end
        ...
        function enableShowDeviceBackgrounds(obj, tf)
            set(obj.configureMenu.showDeviceBackgrounds, 'Enable', symphonyui.ui.util.onOff(tf));
        end

        function enableShowSettings(obj, tf)
            set(obj.configureMenu.showSettings, 'Enable', symphonyui.ui.util.onOff(tf));
        end
