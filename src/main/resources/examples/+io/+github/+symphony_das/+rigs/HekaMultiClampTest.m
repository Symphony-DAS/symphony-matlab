classdef HekaMultiClampTest < symphonyui.core.descriptions.RigDescription
    
    methods
        
        function obj = HekaMultiClampTest()
            ...
            amp2.addConfigurationParameter('banana', 'pow!');
            
            green = UnitConvertingDevice('Green LED', 'V').bindStream(daq.getStream('ANALOG_OUT.2'));
            green.addConfigurationParameter('setting', 'Setting 1');
