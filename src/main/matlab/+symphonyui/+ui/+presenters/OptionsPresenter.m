    ...
    methods (Access = private)
        ...
        function onViewSelectedSave(obj, ~, ~)
            ...
            obj.view.showMessage( ...
                'Options saved. Most values will not apply until the app is restarted.', 'Options Saved');
        ...
        function onViewSelectedDefault(obj, ~, ~)
            result = obj.view.showMessage( ...
                'Are you sure you want to reset options to default values?', 'Reset Options', ...
                'button1', 'Cancel', ...
                'button2', 'Reset');
