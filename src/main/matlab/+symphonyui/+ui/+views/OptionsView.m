classdef OptionsView < appbox.View
    ...
    methods
        ...
        function createUi(obj)
            ...
            obj.generalCard.cleanupFileField = uicontrol( ...
                'Parent', generalGrid, ...
                'Style', 'edit', ...
                'HorizontalAlignment', 'left');
            ...
            obj.generalCard.browseCleanupFileButton = uicontrol( ...
                'Parent', generalGrid, ...
                'Style', 'pushbutton', ...
                'String', '...', ...
                'Callback', @(h,d)notify(obj, 'BrowseCleanupFile'));
            set(generalGrid, ...
                'Widths', [70 -1 23], ...
                'Heights', [23 23]);
            ...
            obj.fileCard.defaultLocationField = uicontrol( ...
                ...
                'Style', 'edit', ...
                'HorizontalAlignment', 'left');
            obj.fileCard.cleanupFunctionField = uicontrol( ...
                'Parent', fileGrid, ...
                'Style', 'edit', ...
                'HorizontalAlignment', 'left');
        ...
        function f = getCleanupFile(obj)
            f = get(obj.generalCard.cleanupFileField, 'String');
        end
        
        function setCleanupFile(obj, f)
            set(obj.generalCard.cleanupFileField, 'String', f);
        end
        ...
        function n = getFileCleanupFunction(obj)
            n = get(obj.fileCard.cleanupFunctionField, 'String');
        end

        function setFileCleanupFunction(obj, l)
            set(obj.fileCard.cleanupFunctionField, 'String', l);
        end
