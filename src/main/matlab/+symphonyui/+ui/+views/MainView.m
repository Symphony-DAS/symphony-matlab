    ...
    methods
        ...
        function createUi(obj)
            ...
            obj.acquireMenu.root = uimenu(obj.figureHandle, ...
                'Label', 'Acquire');
            obj.acquireMenu.viewOnlyProtocol = uimenu(obj.acquireMenu.root, ...
                'Label', 'View Only', ...
                'Accelerator', 'V', ...
                'Callback', @(h,d)notify(obj, 'ViewOnlyProtocol'));
            obj.acquireMenu.recordProtocol = uimenu(obj.acquireMenu.root, ...
                'Label', 'RecordProtocol', ...
                'Accelerator', 'R', ...
            ...
            obj.documentMenu.showDataManager = uimenu(obj.acquireMenu.root, ...
            ...
            obj.viewOnlyProtocolButton = uicontrol( ...
        ...
        function enableViewOnlyProtocol(obj, tf)
            enable = symphonyui.ui.util.onOff(tf);
            set(obj.acquireMenu.viewOnlyProtocol, 'Enable', enable);
            set(obj.viewOnlyProtocolButton, 'Enable', enable);
        end
